    ...
    public class AESHelperWrap 
    {
        ...
        static int _m_Encrypt_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    byte[] _toEncryptArray = LuaAPI.lua_tobytes(L, 1);
                    string _key = LuaAPI.lua_tostring(L, 2);
                    byte[] _ivArray = LuaAPI.lua_tobytes(L, 3);
                    
                        var gen_ret = AESHelper.Encrypt( _toEncryptArray, _key, _ivArray );
        ...
        static int _m_Decrypt_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    byte[] _toDecryptArray = LuaAPI.lua_tobytes(L, 1);
                    string _key = LuaAPI.lua_tostring(L, 2);
                    byte[] _ivArray = LuaAPI.lua_tobytes(L, 3);
                    
                        var gen_ret = AESHelper.Decrypt( _toDecryptArray, _key, _ivArray );
                        LuaAPI.lua_pushstring(L, gen_ret);
