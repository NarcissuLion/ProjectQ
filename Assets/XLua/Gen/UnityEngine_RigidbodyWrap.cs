...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineRigidbodyWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 28, 23, 22);
        ...
        static int _m_DOMove(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Rigidbody.DOMove!");
        ...
        static int _m_DOMoveX(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Rigidbody.DOMoveX!");
        ...
        static int _m_DOMoveY(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Rigidbody.DOMoveY!");
        ...
        static int _m_DOMoveZ(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Rigidbody.DOMoveZ!");
        ...
        static int _m_DORotate(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Rigidbody.DORotate!");
        ...
        static int _m_DOLookAt(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Rigidbody.DOLookAt!");
        ...
        static int _m_DOJump(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Rigidbody.DOJump!");
        ...
        static int _m_DOPath(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Rigidbody.DOPath!");
        ...
        static int _m_DOLocalPath(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Rigidbody.DOLocalPath!");
