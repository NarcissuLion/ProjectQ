...
namespace XLua.CSObjectWrap
{
    ...
    public class IHttpHandlerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(IHttpHandler);
        ...
        {
            return LuaAPI.luaL_error(L, "IHttpHandler does not have a constructor!");
        }
        ...
        static int _m_Post(RealStatePtr L)
        {
		    try {
                ...
                IHttpHandler gen_to_be_invoked = (IHttpHandler)translator.FastGetCSObj(L, 1);
