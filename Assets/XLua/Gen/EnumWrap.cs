...
namespace XLua.CSObjectWrap
{
    ...
    public class ImageAspectRatioFitterAspectModeWrap
    {
		public static void __Register(RealStatePtr L)
        {
		    ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
		    Utils.BeginObjectRegister(typeof(ImageAspectRatioFitter.AspectMode), L, translator, 0, 0, 0, 0);
			Utils.EndObjectRegister(typeof(ImageAspectRatioFitter.AspectMode), L, translator, null, null, null, null, null);
			
			Utils.BeginClassRegister(typeof(ImageAspectRatioFitter.AspectMode), L, null, 6, 0, 0);

            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "None", ImageAspectRatioFitter.AspectMode.None);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "ByWidth", ImageAspectRatioFitter.AspectMode.ByWidth);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "ByHeight", ImageAspectRatioFitter.AspectMode.ByHeight);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "OriginSize", ImageAspectRatioFitter.AspectMode.OriginSize);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "ImportSize", ImageAspectRatioFitter.AspectMode.ImportSize);
            

			Utils.RegisterFunc(L, Utils.CLS_IDX, "__CastFrom", __CastFrom);
            
            Utils.EndClassRegister(typeof(ImageAspectRatioFitter.AspectMode), L, translator);
        }
        ...
        static int __CastFrom(RealStatePtr L)
		{
            ...
            if (lua_type == LuaTypes.LUA_TNUMBER)
            {
                translator.PushImageAspectRatioFitterAspectMode(L, (ImageAspectRatioFitter.AspectMode)LuaAPI.xlua_tointeger(L, 1));
            }
            ...
            else if(lua_type == LuaTypes.LUA_TSTRING)
            {
			    ...
			    if (LuaAPI.xlua_is_eq_str(L, 1, "None"))
                {
                    translator.PushImageAspectRatioFitterAspectMode(L, ImageAspectRatioFitter.AspectMode.None);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "ByWidth"))
                {
                    translator.PushImageAspectRatioFitterAspectMode(L, ImageAspectRatioFitter.AspectMode.ByWidth);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "ByHeight"))
                {
                    translator.PushImageAspectRatioFitterAspectMode(L, ImageAspectRatioFitter.AspectMode.ByHeight);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "OriginSize"))
                {
                    translator.PushImageAspectRatioFitterAspectMode(L, ImageAspectRatioFitter.AspectMode.OriginSize);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "ImportSize"))
                {
                    translator.PushImageAspectRatioFitterAspectMode(L, ImageAspectRatioFitter.AspectMode.ImportSize);
                }
				else
                {
                    return LuaAPI.luaL_error(L, "invalid string for ImageAspectRatioFitter.AspectMode!");
                }
            ...
            {
                return LuaAPI.luaL_error(L, "invalid lua type for ImageAspectRatioFitter.AspectMode! Expect number or string, got + " + lua_type);
            }
