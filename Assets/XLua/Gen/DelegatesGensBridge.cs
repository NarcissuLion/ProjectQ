...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp0(int p0, string p1)
		{
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new LuaClient.OnSceneLoad(__Gen_Delegate_Imp0);
			}
		
		    if (type == typeof(LuaClient.OnSceneUnload))
			{
			    return new LuaClient.OnSceneUnload(__Gen_Delegate_Imp0);
			}
		
		    if (type == typeof(LuaClient.OnSceneLoaded))
			{
			    return new LuaClient.OnSceneLoaded(__Gen_Delegate_Imp1);
			}
		
		    if (type == typeof(LuaClient.OnClickEscape))
			{
			    return new LuaClient.OnClickEscape(__Gen_Delegate_Imp2);
			}
		
		    if (type == typeof(LuaClient.OnClick))
			{
			    return new LuaClient.OnClick(__Gen_Delegate_Imp3);
			}
		
		    if (type == typeof(LuaClient.OnOnApplicationPause))
			{
			    return new LuaClient.OnOnApplicationPause(__Gen_Delegate_Imp4);
			}
