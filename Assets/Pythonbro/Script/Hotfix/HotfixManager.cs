...
public class HotfixManager : MonoBehaviour {
    ...
    public static readonly string RESOURCE_PREFIX = "assets/game/resources/";
    ...
    private IEnumerator LoadResourceAsync<T>(string path, System.Action<T> callback) where T : Object {
        ...
        if (bundle != null) {
            ...
            yield return req;
            resourceCachePool.OnLoadResource(req.asset, path, group, null);
            SafeInvoke(callback, req.asset as T);
        }
    }
